...
export default function MenuItem(props) {
    ...
    return (React.createElement("sp-menu-item", { ref: ref, key: props.key, "class": props.className, disabled: props.disabled || undefined, selected: props.selected || undefined }, props.children));
}
